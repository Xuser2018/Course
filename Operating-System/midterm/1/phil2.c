...
// sudo[1][2]=1;
/* create the thread */
pthread_create(&tid,&attr,runner,&condi[0]);
pthread_create(&tid2,&attr2,runner,&condi[1]);
pthread_create(&tid3,&attr3,runner,&condi[2]);
pthread_create(&tid3,&attr4,runner,&condi[3]);
pthread_create(&tid3,&attr5,runner,&condi[4]);
